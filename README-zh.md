...
- 图书：[The Self-Hosted AI Builder’s Guide](https://www.amazon.com/dp/B0HDCKSD6V)、[Privacy Tools in the Age of AI](docs/vpn-book-zh.md)
...
- [为 VPN 客户端启用 Bonjour/mDNS 服务发现](docs/advanced-usage-zh.md#为-vpn-客户端启用-bonjourmdns-服务发现)
