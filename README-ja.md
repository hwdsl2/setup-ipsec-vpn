...
- Docker AI/音声：[Whisper (STT)](https://github.com/hwdsl2/docker-whisper)、[Kokoro (TTS)](https://github.com/hwdsl2/docker-kokoro)、[Embeddings](https://github.com/hwdsl2/docker-embeddings)、[LiteLLM](https://github.com/hwdsl2/docker-litellm)、[Ollama (LLM)](https://github.com/hwdsl2/docker-ollama)
